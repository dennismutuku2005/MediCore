...
export function Sidebar({ isSidebarOpen, setIsSidebarOpen, isMobile, pathname }) {
    ...
    const navigation = [
        ...
        ...(hasPolicy('view_income') ? [{
            id: 'income',
            name: 'Income',
            icon: CreditCard,
            children: [
                { name: 'Income Analytics', href: '/dashboard/income' },
                { name: 'Expenses', href: '/dashboard/expenses' },
                { name: 'Financial Report', href: '/dashboard/report' },
                { name: 'PDF Reports', href: '/dashboard/pdf-reports' },
                { name: 'M-Pesa Transactions', href: '/dashboard/mpesa' },
            ]
        }] : []),
        ...
        ...(hasPolicy('manage_customers') ? [{
            id: 'customers',
            name: 'Customers',
            icon: Users,
            children: [
                { name: 'Customer List', href: '/dashboard/customers' },
                { name: 'Active Connections', href: '/dashboard/customers/active' },
                { name: 'Block STK', href: '/dashboard/customers/block-stk' },
            ]
        }] : []),

        ...(hasPolicy('view_routers') ? [{ id: 'routers', name: 'Routers', href: '/dashboard/routers', icon: Network }] : []),
        ...
        ...(hasPolicy('manage_users') ? [
            { id: 'staff', name: 'Users & Policies', href: '/dashboard/staff', icon: UserRoundCheck },
        ] : []),
