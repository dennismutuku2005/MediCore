                                ...
                                customers.map((customer, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <Badge variant={customer.used ? 'success' : 'error'} className="text-[8px] font-medium px-2 py-0.5 border-none uppercase tracking-widest rounded-md">
                                                    {customer.used ? 'Yes' : 'No'}
                                                </Badge>
                                            </td>
